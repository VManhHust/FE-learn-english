export const vocabularyI18n = {
  ...
  studyProgressSubtitle: 'Theo dõi bộ từ đang học và năng suất mỗi ngày',
  totalCards: 'Tổng số Thẻ',
  mastered: 'Thành thạo',
  notMastered: 'Chưa thành thạo',
  unlearned: 'Chưa học',
  reviews: 'Lần Ôn tập',
  totalStudyDays: 'Tổng số ngày học',
  studiedDecks: 'Bộ đã học',
  learningDecks: 'Bộ đang học',
  completedDecks: 'Bộ hoàn thành',
  activityHeatmap: 'Năng suất học mỗi ngày',
  noActivity: 'Chưa học',
  lowActivity: 'Ít',
  mediumActivity: 'TB',
  highActivity: 'Nhiều',
