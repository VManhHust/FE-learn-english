...
export function VocabularySectionNav({ lang }: { lang: 'vi' | 'en' }) {
  ...
  return (
    <nav className="sticky top-0 z-30 mb-4 rounded-xl border border-[#ded8cc] bg-white/90 p-1 shadow-[0_3px_12px_rgba(72,58,31,0.06)] backdrop-blur-xl dark:border-[#34312d] dark:bg-[#171614]/90">
        ...
        {items.map(({ href, icon: Icon, vi, en }) => {
          ...
          return (
            <button
              ...
              className={cn(
                'flex h-8 flex-1 items-center justify-center gap-1.5 rounded-lg border border-transparent px-4 text-[13px] font-semibold transition-all duration-200',
                active
