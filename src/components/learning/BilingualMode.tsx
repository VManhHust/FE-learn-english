    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      {tab === 'both' ? (
        ...
        <div className="border-b border-gray-200 dark:border-[#2e3142]">
          <div className="max-w-4xl mx-auto px-4 py-2 text-xs font-bold tracking-widest text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-[#1a1d27]">
      ...
      {/* Segment list */}
      <div className="flex-1 overflow-y-auto p-4 bg-gray-50 dark:bg-[#0d0f14]">
        ...
        {sorted.map((seg, idx) => {
            ...
            return (
              ...
              >
                {tab === 'english' && (
                  ...
                  >
                    <span className="text-sm font-bold text-gray-400 dark:text-gray-500 mt-0.5 flex-shrink-0 w-8 text-right">
                      {idx + 1}
                    </span>
                ...
                {tab === 'vietnamese' && (
                  ...
                  >
                    ...
                    {seg.translation ? (
                      <p className="text-base leading-relaxed italic font-medium" style={{ color: '#3b82f6' }}>
                        {seg.translation}
                      </p>
                    ) : (
                      <p className="text-base leading-relaxed italic text-gray-400 dark:text-gray-500">
                        (Chưa có bản dịch)
                      </p>
                    )}
                  </div>
          ...
          // For "both" view, use two-column layout
          return (
          <div
            key={seg.segmentIndex}
          ...
          >
            ...
            {(tab === 'both' || tab === 'english') && (
              <div 
                className="flex-1 px-4 py-4 flex gap-3 items-start" 
                style={{ 
                  minWidth: 0,
                  border: '2px solid #d4af37',
                  borderRadius: '16px',
              ...
              >
                ...
                <p className="text-sm text-gray-900 dark:text-gray-100 leading-relaxed font-medium">{seg.text}</p>
              </div>
            )}
            ...
            {(tab === 'both' || tab === 'vietnamese') && (
              ...
              >
                ...
                {seg.translation ? (
                  <p className="text-sm leading-relaxed italic font-medium" style={{ color: '#3b82f6' }}>
                    {seg.translation}
                  </p>
                ) : (
                  <p className="text-sm leading-relaxed italic text-gray-400 dark:text-gray-500">
                    (Chưa có bản dịch)
                  </p>
                )}
              </div>
